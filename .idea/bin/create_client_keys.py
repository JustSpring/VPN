...
def create_private_key():
    ...
    with open("../server/client_key.pem", "wb") as key_file:
        key_file.write(pem)
...
def generate_client_csr(client_private_key):
    ...
    with open("../server/client_csr.pem", "wb") as key_file:
...
def sign_csr_by_ca(ca_private_key,ca_cert,csr):
    ...
    with open("../server/client_cert.pem", "wb") as cert_file:
...
def load_ca_private_key():
    with open("../server/certificates/ca_key.pem", "rb") as key_file:
...
def load_ca_cert():
    with open("../server/certificates/ca_cert.pem", "rb") as cert_file:
